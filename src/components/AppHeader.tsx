...
export default function AppHeader({
  ...
  return (
    <div className="sticky top-0 z-20 bg-blue-600 text-white px-4 pt-[calc(0.625rem_+_env(safe-area-inset-top))] pb-2.5 flex items-center gap-2.5 flex-shrink-0">
        ...
        {section === 'chat' && (
          <input type="search" value={searchInput} onChange={e => onSearchChange(e.target.value)}
        ...
        {section === 'hashtags' && !activeHashtagName && (
          <>
            <input
              value={hashtagFilter} onChange={e => onHashtagFilterChange(e.target.value)}
              placeholder="Filter…"
