...
export const rowSel    = 'bg-mist-100! dark:bg-mist-800/40!'
...
export const timeCls   = 'text-[11px] text-gray-400 dark:text-gray-500 leading-6 opacity-0 [@media(hover:hover)]:group-hover/row:opacity-100 transition-opacity'
